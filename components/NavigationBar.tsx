        ...
        <div className="flex mx-auto justify-between  ">
          ...
          <div className="flex items-center gap-4 mt-2  justify-between w-full">
            ...
            <div className="hidden lg:flex gap-16 justify-center items-center">
              ...
              <a
                href="/submit"
                className="text-white bg-[#24292F] hover:bg-[#24292F]/90 focus:ring-4 focus:outline-none focus:ring-[#24292F]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center  me-2 mx-auto "
              >
                SUBMIT
              </a>
            </div>
